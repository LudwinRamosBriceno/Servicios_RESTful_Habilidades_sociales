"""Modelos de datos para el servicio de usuarios con Pydantic."""
...
class UpdateUserRequest(BaseModel):
    """Payload para actualizacion parcial de un usuario."""
...
class UserListItemResponse(BaseModel):
    """Respuesta para listar usuarios con informacion minima."""
...
class AddSkillResponse(BaseModel):
    """Respuesta de la operacion de alta/acumulacion de habilidad."""
