...
El servicio de Pedidos generará más registros con el tiempo (cada pedido es una transacción), mientras que Usuarios y Productos tendrán volúmenes de datos más estables. El equipo tiene limitaciones de recursos locales (Minikube en laptops de estudiantes), por lo que las capacidades deben ser realistas pero suficientes para el MVP.
